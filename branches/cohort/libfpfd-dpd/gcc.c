...
_Decimal32
__dpd_addsd3(_Decimal32 lhs, _Decimal32 rhs)
{
...
_Decimal32
__dpd_subsd3(_Decimal32 lhs, _Decimal32 rhs)
{
  fpfd32_union_t ret_cast, lhs_cast, rhs_cast;
  lhs_cast.dec = lhs;
  rhs_cast.dec = rhs;
...
_Decimal32
__dpd_mulsd3(_Decimal32 lhs, _Decimal32 rhs)
{
  fpfd32_union_t ret_cast, lhs_cast, rhs_cast;
  lhs_cast.dec = lhs;
  rhs_cast.dec = rhs;
...
_Decimal32
__dpd_divsd3(_Decimal32 lhs, _Decimal32 rhs)
{
  fpfd32_union_t ret_cast, lhs_cast, rhs_cast;
  lhs_cast.dec = lhs;
  rhs_cast.dec = rhs;
