...
main()
{
  ...
  fpfd32_impl_set_manually(&number32, UINT32_C(0), UINT32_C(0x1234567));
  fpfd_impl_assert_oresf(impl_inc, &number, 0, 1, FPFD_NUMBER);
  fpfd32_impl_assert_mant(&number32, UINT32_C(0), UINT32_C(0x1234568));

  fpfd_impl_set_esf(&nines, 0, -1, FPFD_NUMBER);
  fpfd32_impl_set_manually(&nines32, UINT32_C(0), UINT32_C(0x9999999));
  fpfd_impl_assert_oresf(impl_inc, &nines, 1, -1, FPFD_NUMBER);
  fpfd32_impl_assert_mant(&nines32, UINT32_C(0), UINT32_C(0x1000000));

  fpfd_impl_set_esf(&overflow, 90, 1, FPFD_NUMBER);
  fpfd32_impl_set_manually(&overflow32, UINT32_C(0), UINT32_C(0x9999999));
