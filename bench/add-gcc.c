...
void
gcc64_bench_add(unsigned int trials)
{
  ...
  for (i = 0; i < trials; ++i) {
    ...
    if (GCC_DPD) {
      record_ticks("__dpd_adddd3", ticks2 - ticks1);
    } else if (GCC_BID) {
      record_ticks("__bid_adddd3", ticks2 - ticks1);
    }
  }
}

void
gcc128_bench_add(unsigned int trials)
{
  ...
  for (i = 0; i < trials; ++i) {
    ...
    if (GCC_DPD) {
      record_ticks("__dpd_addtd3", ticks2 - ticks1);
    } else if (GCC_BID) {
      record_ticks("__bid_addtd3", ticks2 - ticks1);
    }
  }
}
