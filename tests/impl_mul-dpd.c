...
main()
{
  ...
  fpfd_impl_assert_ora2esfh(impl_mul, &res, &lhs, &rhs, 3, 1, FPFD_NUMBER, 3);
  ...
  fpfd_impl_assert_ora2esfh(impl_mul, &res, &lhs, &rhs, 0, -1, FPFD_NUMBER, 0);
  ...
  fpfd_impl_assert_ora2esfh(impl_mul, &res, &lhs, &rhs, 2, 1, FPFD_NUMBER, 2);
